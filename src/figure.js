...
const SHAPES = {
  front: {
    ...
    deltSide:   DELT_SIDE,
    chest:      'M101,74 C94,74 85,76 80,80 C76,85 75,96 79,104 C86,114 95,120 100,120 C98,105 98,89 101,74 Z',
    ...
    calves:     'M92,300 C85,298 79,304 77,315 C76,328 78,342 82,354 C85,362 88,364 90,361 C92,348 92,322 92,300 Z',
    biceps:     UPPER_ARM,
    forearms:   FOREARM,
  },
  back: {
    ...
    calves: [
      'M95,298 C89,297 83,302 81,312 C79,325 81,340 85,352 C88,359 92,359 94,354 C96,341 96,318 95,298 Z',
      'M80,302 C77,306 76,316 77,327 C78,337 80,346 83,352 C85,349 84,338 82,326 C81,316 80,308 80,302 Z',
    ],
    triceps:    UPPER_ARM,
    forearms:   FOREARM,
  },
